...
public interface MessagesApi {
    ...
    @ApiOperation(value = "Report that a message was read", notes = "This service can be called with an empty HTTP request body. An HTTP header \"Content-Length\" with value 0 should be present in the request.", response = Void.class, tags={ "messages", })
    @ApiResponses(value = { 
