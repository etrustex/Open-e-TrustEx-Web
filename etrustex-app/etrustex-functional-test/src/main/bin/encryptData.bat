...
set CLASSPATH=%CLASSPATH%;./../lib/xmlsec-2.0.7.jar;./../lib/commons-logging-1.2.jar;./../lib/log4j-1.2.17.jar

java -cp "%CLASSPATH%" -Dlog4j.configuration=file:../resources/log4j.properties eu.europa.ec.etrustex.tools.EncryptData %1 %2