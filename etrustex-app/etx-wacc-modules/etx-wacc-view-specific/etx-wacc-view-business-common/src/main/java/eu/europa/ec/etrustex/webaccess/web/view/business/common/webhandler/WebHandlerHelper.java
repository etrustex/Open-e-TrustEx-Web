...
public class WebHandlerHelper {
    ...
    public void addJsonParameters(Map<String, Object> model, String icaNodePartyName,
        ...
        try {
            ...
            model.put("encodedFileElements", Base64.encodeBase64String(fileElementsAsJson.getBytes(StandardCharsets.UTF_8)));
            ...
            if (CollectionUtils.isNotEmpty(signatures)) {
                ...
                String xmlExtractedSignature = Base64.encodeBase64String(signatureVO.getSignature().getBytes(StandardCharsets.UTF_8));
                model.put("xmlExtractedSignature", xmlExtractedSignature);
                String xmlDataToSign = Base64.encodeBase64String(signatureVO.getSignedData().getBytes(StandardCharsets.UTF_8));
                model.put("xmlDataToSign", xmlDataToSign);
                model.put("xmlSignedBundle", Base64.encodeBase64String("TODO!".getBytes(StandardCharsets.UTF_8)));
