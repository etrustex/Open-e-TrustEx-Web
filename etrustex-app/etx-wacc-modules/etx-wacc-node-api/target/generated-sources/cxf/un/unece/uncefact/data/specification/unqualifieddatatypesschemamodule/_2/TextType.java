...
import ec.schema.xsd.commonaggregatecomponents_2.BusinessDocumentTypeType;
import ec.schema.xsd.commonaggregatecomponents_2.CreatorType;
import ec.schema.xsd.commonaggregatecomponents_2.DigestMethodType;
import ec.schema.xsd.commonaggregatecomponents_2.DigestValueType;
import ec.schema.xsd.commonaggregatecomponents_2.FormatType;
import ec.schema.xsd.commonaggregatecomponents_2.UserIDType;
...
@XmlSeeAlso({
    FailedAssertType.class,
    FormatType.class,
    CreatorType.class,
    ec.schema.xsd.commonaggregatecomponents_2.TitleType.class,
    UserIDType.class,
    BusinessDocumentTypeType.class,
    DigestMethodType.class,
    ec.schema.xsd.commonaggregatecomponents_2.CanonicalizationMethodType.class,
    DigestValueType.class,
    ...
    oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.CanonicalizationMethodType.class,
    ...
    oasis.names.specification.ubl.schema.xsd.commonbasiccomponents_2.TitleType.class,
