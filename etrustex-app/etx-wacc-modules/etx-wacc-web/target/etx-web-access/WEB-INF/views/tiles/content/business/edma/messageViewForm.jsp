    ...
    <div class="business-edma-metadata">
        <div class="business-edma-metadata-column left">
            ...
            <div class="grid">
                ...
                <span class="grid-row">
                    <span class="grid-cell hi-label"><spring:message code="label.compNatRegNumber"/></span>
                    <span class="grid-cell label value-container">
                        <spring:message text="${edmaMessage.senderRegNumber}" htmlEscape="true"/>
                    </span>
                </span>
                <span class="grid-row">
            ...
            <div class="grid">
                <span class="grid-row">
                    <span class="grid-cell hi-label fixed-label-container"><spring:message code="label.informationReference"/></span>
                    <span class="grid-cell label value-container">
                        <spring:message text="${edmaMessage.msgInfoNo}" htmlEscape="true"/>
                    </span>
                </span>
                <span class="grid-row">
                    <span class="grid-cell hi-label"><spring:message code="label.fileReference"/></span>
                    <span class="grid-cell label value-container">
                ...
                <span class="grid-row">
                    <span class="grid-cell hi-label"><spring:message code="label.inAttentionOf"/></span>
                    <span class="grid-cell label value-container">
                        <spring:message text="${edmaMessage.msgInAttentionOf}" htmlEscape="true"/>
                    </span>
                </span>
             </div>
        </div>
        ...
        <div class="business-edma-metadata-column right">
            ...
            <div class="grid">
                ...
                <span class="grid-row">
                    <span class="grid-cell hi-label"><spring:message code="label.compNatRegNumber"/></span>
                    <span class="grid-cell label value-container">
                        <spring:message text="${edmaMessage.onBehalfRegNo}" htmlEscape="true"/>
                    </span>
                </span>
                <span class="grid-row">
                    <span class="grid-cell hi-label"><spring:message code="label.contactPerson"/></span>
            ...
            <div class="grid">
                <span class="grid-row">
                    <span class="grid-cell hi-label fixed-label-container"><spring:message code="label.distribution"/></span>
