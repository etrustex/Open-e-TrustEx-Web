   ...
   */
		...
		value: function sign(privateKey) {
			...
			sequence = sequence.then(function (result) {
				...
				_this2.signatureAlgorithm = result.signatureAlgorithm;
			});
			//endregion

			//region Create TBS data for signing
			sequence = sequence.then(function () {
				_this2.tbsResponseData.tbs = _this2.tbsResponseData.toSchema(true).toBER(false);
			});
			//endregion

			//region Signing TBS data on provided private key
			sequence = sequence.then(function () {
				return engine.subtle.signWithPrivateKey(_this2.tbsResponseData.tbs, privateKey, parameters);
			});
