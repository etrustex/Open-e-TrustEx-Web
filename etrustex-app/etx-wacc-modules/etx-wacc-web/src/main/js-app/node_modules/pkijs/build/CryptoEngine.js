   ...
   */
		...
		value: function verifyWithPublicKey(data, signature, publicKeyInfo, signatureAlgorithm) {
			...
			sequence = sequence.then(function () {
				...
				var algorithmObject = _this7.getAlgorithmByOID(signatureAlgorithm.algorithmId);
				if ("name" in algorithmObject === "") return Promise.reject("Unsupported public key algorithm: " + signatureAlgorithm.algorithmId);

				var algorithm = _this7.getAlgorithmParameters(algorithmObject.name, "importkey");
				...
				if (algorithmObject.name === "ECDSA") {
					...
					var curveObject = _this7.getAlgorithmByOID(publicKeyInfo.algorithm.algorithmParams.valueBlock.toString());
				...
				return _this7.importKey("spki", publicKeyInfoView, algorithm.algorithm, true, algorithm.usages);
			});
			//endregion
