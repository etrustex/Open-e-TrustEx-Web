...
public class AttachmentController {
    ...
    public void downloadAttachment(HttpServletResponse response, @RequestParam(value = "attachmentId", required = true) String attachmentId) throws IOException {
        ...
        if (attachment != null) {
            ...
            if (isAuthorized(message)) {
                NodeAttachment nodeAttachment = attachmentHandler.retrieveNodeAttachment(attachment);
                ...
                if (nodeAttachment != null) {
                    ...
                    response.setHeader("fileSize", Long.toString(nodeAttachment.getDocumentSize()));
