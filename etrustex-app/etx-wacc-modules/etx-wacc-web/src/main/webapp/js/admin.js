...
$(document).ready(function() {
  ...
  $("#exportPartyUsers")
    .click(function () {
      if ($("#business").val().length > 0) {
        var businessId = $("#business").val();
        window.location =  "/e-trustex/exportPartyUsers.do?businessId="+businessId;
      } else {
          console.log('Please select your business domain');
        $("#select-business-dialog").dialog("open");
      }
