...
<div id="select-business-dialog" title="<spring:message code="label.admin.no.business.domain.selected"/>">
    <p>
        <span class="header-value"><spring:message code="label.admin.select.one.business.domain"/></span>
    </p>
</div>