...
//        when (attachmentHandler.saveAttachmentInfo(referenceId,name,"",mimeType,size,attachmentType,transmissionChecksum,transmissionChecksumMethod)).thenReturn(attachment);
//
...
//        InputStream inputStream = mock(InputStream.class);
//
//        doThrow(new Exception()).when(attachmentHandler).uploadAttachmentToNode(localPartyId, referenceId, size, attachmentType, encryptedKey,
