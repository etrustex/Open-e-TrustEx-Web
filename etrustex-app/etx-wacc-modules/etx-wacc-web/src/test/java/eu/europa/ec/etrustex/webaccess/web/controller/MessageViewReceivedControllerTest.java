...
public class MessageViewReceivedControllerTest extends AbstractControllerTest {
    @InjectMocks
    private MessageViewReceivedController controller;

    @Mock
    private SecurityChecker securityChecker;

    @Test
    public void test_getAction_should_returnMessageViewReceivedAction() throws Exception {
        // DO THE ACTUAL CALL
        assertThat(controller.getAction(), is(equalTo(WebAction.MESSAGE_VIEW_RECEIVED)));
    }
