...
public class AttachmentHandlerImpl implements AttachmentHandler {
    ...
    @Override
    public void uploadAttachmentToNode(long localPartyId, String referenceId, long size, String attachmentType,
    ...
    @Transactional(readOnly = false)
    public Attachment saveAttachmentInfo(String referenceId, String name, String path, String mimeType, long size, String attachmentType, byte[] transmissionChecksum, String transmissionChecksumMethod) {
        ...
        attachment.setContentChecksum(null);
        attachment.setContentChecksumMethod(null);
    ...
    public NodeAttachment retrieveNodeAttachment(Attachment attachment) {
        return this.retrieveNodeAttachment(attachment, false);
    }

    @Override
    public NodeAttachment retrieveNodeAttachment(Attachment attachment, boolean downloadAsSender) {
        ...
        final String remotePartyName = downloadAsSender ? localParty.getNodeName() : message.getRemoteParty().getNodeName();
