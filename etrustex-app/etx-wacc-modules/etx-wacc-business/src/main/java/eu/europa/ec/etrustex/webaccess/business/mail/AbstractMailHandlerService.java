...
public abstract class AbstractMailHandlerService implements MailHandlerService {
    ...
    private void buildStatusMailContentData(MailContentData mailContentData, StatusMailContentDTO statusMailContentDTO) {
        ...
        mailContentData.setMessageSentOnDate(dateFormat.format(statusMailContentDTO.getMessage().getSentOn()));
        mailContentData.setMessageSentOnTime(timeFormat.format(statusMailContentDTO.getMessage().getSentOn()));
    }
