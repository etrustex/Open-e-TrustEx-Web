...
public class Configuration {
    ...
    protected static final String CONFIG_ZIP_SPLIT_SIZE = "etx.web.zip.split_size";
    protected static final String CONFIG_USERGUIDE_URL = "etx.web.userguide.url";
    protected static final String CONFIG_SUPPORT_EMAIL = "etx.web.support.email";
    protected static final String ARCHIVE_FILE_EXTENSIONS = "etx.web.archive.file.extensions";
    ...
    private Integer zipSplitSize;
    private String userGuideUrl;
    private String supportEmail;
    private String archiveFilesExtensions;
    ...
    public Integer getZipSplitSize() {
        return zipSplitSize != null ? zipSplitSize : 1024*1024*1024;
}

    public void setZipSplitSize(String zipSplitSize) {
        try {
            this.zipSplitSize = Integer.parseInt(zipSplitSize);
        } catch (NumberFormatException e) {
            this.zipSplitSize =  1024*1024*1024; // TODO: log the error!
        }
    }
    ...
    public void setArchiveFileExtensions(String archiveFilesExtensions) {
        this.archiveFilesExtensions = archiveFilesExtensions.toUpperCase().trim();
    }
    public String getArchiveFilesExtensions() {
        return this.archiveFilesExtensions;
    }
}
