...
public class AbstractMailHandlerServiceTest extends AbstractTest {
    ...
    public void test_prepareStatusMailForParty_should_returnPartyMail_fromTemplate() throws Exception {
        ...
        assertThat(statusMailContentData.getMessageSentOnDate(), is(AbstractMailHandlerService.dateFormat.format(message.getSentOn())));
        assertThat(statusMailContentData.getMessageSentOnTime(), is(AbstractMailHandlerService.timeFormat.format(message.getSentOn())));
