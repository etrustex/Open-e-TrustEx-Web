...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:ec="ec:schema:xsd:CreateParty-2_1"
	...
	<xsl:template match="/">
		  <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
			...
			<svrl:ns-prefix-in-attribute-values uri="ec:schema:xsd:CommonAggregateComponents-2_1" prefix="eccac"/>
			 <svrl:ns-prefix-in-attribute-values uri="ec:schema:xsd:CreateParty-2_1" prefix="ec"/>
	...
	<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Business rules for e-TrustEx CreateParty version 2.1</svrl:text>
	   ...
	   <!--PATTERN -->
		...
		<!--RULE -->
	<xsl:template match="*[local-name()='CreateParty']/eccac:Party" priority="1002" mode="M11">
		  <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
						   context="*[local-name()='CreateParty']/eccac:Party"/>
		...
		<xsl:apply-templates select="*" mode="M11"/>
		  ...
		  <!--RULE -->
	<xsl:template match="*[local-name()='CreateParty']/eccac:Party/cac:PartyName/cbc:Name"
					 priority="1001"
					 mode="M11">
		  <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
						   context="*[local-name()='CreateParty']/eccac:Party/cac:PartyName/cbc:Name"/>
		...
		<xsl:choose>
		  ...
		  <!--RULE -->
	<xsl:template match="*[local-name()='CreateParty']/eccac:Party/cac:PartyIdentification/cbc:ID"
					 priority="1000"
					 mode="M11">
		  <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
						   context="*[local-name()='CreateParty']/eccac:Party/cac:PartyIdentification/cbc:ID"/>
