...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:ec="ec:schema:xsd:DownloadTrackingFilesResponse-0.1"
...
<xsl:template match="/">
      <svrl:schematron-output xmlns:xs="http://www.w3.org/2001/XMLSchema"
                              xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Business rules for e-PRIOR DownloadTrackingFilesResponse"
                              schemaVersion="">
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:DocumentStatusCode-1.0"
                                             prefix="stat"/>
         <svrl:ns-prefix-in-attribute-values uri="ec:schema:xsd:DownloadTrackingFilesResponse-0.1" prefix="ec"/>
         <svrl:active-pattern>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M8"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">DownloadTrackingFilesResponse_code_list_rules</xsl:attribute>
            <xsl:attribute name="name">DownloadTrackingFilesResponse_code_list_rules</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:xs="http://www.w3.org/2001/XMLSchema"
              xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Business rules for e-PRIOR DownloadTrackingFilesResponse</svrl:text>

   <!--PATTERN -->


	<!--RULE -->
<xsl:template match="*[local-name()='DownloadTrackingFilesResponse']/ec:ID" priority="1000"
                 mode="M8">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='DownloadTrackingFilesResponse']/ec:ID"/>
...
<xsl:choose>
   ...
   <!--PATTERN DownloadTrackingFilesResponse_code_list_rules-->
