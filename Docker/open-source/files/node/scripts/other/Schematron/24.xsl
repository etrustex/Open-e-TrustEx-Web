...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:DocumentStatusCode-1.0"
                                             prefix="stat"/>
         <svrl:ns-prefix-in-attribute-values uri="ec:schema:xsd:DocumentBundle-0.1" prefix="ec"/>
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">DocumentBundle_code_list_rules</xsl:attribute>
            <xsl:attribute name="name">DocumentBundle_code_list_rules</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="*[local-name()='DocumentBundle']/cbc:ParentDocumentID" priority="1000"
                 mode="M11">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='DocumentBundle']/cbc:ParentDocumentID"/>
...
<xsl:choose>
   ...
   <!--PATTERN DocumentBundle_code_list_rules-->


	<!--RULE -->
<xsl:template match="cbc:ParentDocumentTypeCode" priority="1000" mode="M12">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cbc:ParentDocumentTypeCode"/>

		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="( ( not(contains(normalize-space(.),' ')) and contains( ' BDL ',concat(' ',normalize-space(.),' ') ) ) )"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="( ( not(contains(normalize-space(.),' ')) and contains( ' BDL ',concat(' ',normalize-space(.),' ') ) ) )">
               <xsl:attribute name="flag">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
               <svrl:text>error.invalid_codetable_value_parentdocumenttypecode</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M12"/>
