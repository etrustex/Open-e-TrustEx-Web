...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Business rules for e-TrustEx RetrieveDocumentWrapperRequest"
                              schemaVersion="">
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">RetrieveDocumentWrapperRequest_code_list_rules</xsl:attribute>
            <xsl:attribute name="name">RetrieveDocumentWrapperRequest_code_list_rules</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Business rules for e-TrustEx RetrieveDocumentWrapperRequest</svrl:text>

   <!--PATTERN -->


    <!--RULE -->
<xsl:template match="*[local-name()='DocumentWrapperRequest']" priority="1000" mode="M10">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='DocumentWrapperRequest']"/>
...
<xsl:choose>
   ...
   <!--PATTERN RetrieveDocumentWrapperRequest_code_list_rules-->
