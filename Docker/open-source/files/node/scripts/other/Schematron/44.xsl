...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:ec="ec:schema:xsd:QueryRequest-1"
...
<xsl:template match="/">
      <svrl:schematron-output xmlns:xs="http://www.w3.org/2001/XMLSchema"
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:DocumentStatusCode-1.0"
                                             prefix="stat"/>
         <svrl:ns-prefix-in-attribute-values uri="ec:schema:xsd:QueryRequest-1" prefix="ec"/>
         <svrl:active-pattern>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:Period" priority="1000" mode="M8">
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:Period/cbc:StartDate" priority="1000" mode="M9">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
