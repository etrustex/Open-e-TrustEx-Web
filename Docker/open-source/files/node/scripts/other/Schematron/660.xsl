...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:ec="ec:schema:xsd:UpdateTrackingFilesStepResponse-0.1"
...
<xsl:template match="/">
      <svrl:schematron-output xmlns:xs="http://www.w3.org/2001/XMLSchema"
                              xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Business rules for e-PRIOR UpdateTrackingFilesStepResponse"
                              schemaVersion="">
         ...
         <svrl:ns-prefix-in-attribute-values uri="urn:oasis:names:specification:ubl:schema:xsd:DocumentStatusCode-1.0"
                                             prefix="stat"/>
         <svrl:ns-prefix-in-attribute-values uri="ec:schema:xsd:UpdateTrackingFilesStepResponse-0.1" prefix="ec"/>
         <svrl:active-pattern>
            <xsl:apply-templates/>
         </svrl:active-pattern>
         <xsl:apply-templates select="/" mode="M8"/>
         <svrl:active-pattern>
            <xsl:attribute name="id">UpdateTrackingFilesStepResponse_code_list_rules</xsl:attribute>
            <xsl:attribute name="name">UpdateTrackingFilesStepResponse_code_list_rules</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:xs="http://www.w3.org/2001/XMLSchema"
              xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Business rules for e-PRIOR UpdateTrackingFilesStepResponse</svrl:text>

   <!--PATTERN -->


	<!--RULE -->
<xsl:template match="*[local-name()='UpdateTrackingFilesStepResponse']/ec:ID" priority="1000"
                 mode="M8">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='UpdateTrackingFilesStepResponse']/ec:ID"/>
...
<xsl:choose>
   ...
   <!--PATTERN UpdateTrackingFilesStepResponse_code_list_rules-->
