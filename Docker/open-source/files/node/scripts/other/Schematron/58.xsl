...
<xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Business rules for e-TrustEx SubmitApplicationResponse"
                              schemaVersion="">
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">SubmitApplicationResponse_code_list_rules</xsl:attribute>
            <xsl:attribute name="name">SubmitApplicationResponse_code_list_rules</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Business rules for e-TrustEx SubmitApplicationResponse</svrl:text>

   <!--PATTERN -->


	<!--RULE -->
<xsl:template match="*[local-name()='ApplicationResponse']/cac:DocumentResponse/cac:DocumentReference/cbc:ID"
                 priority="1000"
                 mode="M10">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='ApplicationResponse']/cac:DocumentResponse/cac:DocumentReference/cbc:ID"/>
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>error.parent_document_id_invalid_char</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M10"/>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="cac:DocumentReference" priority="1000" mode="M11">
...
<xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>error.parent_document_documenttypecode_check</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="not ( normalize-space(cbc:DocumentTypeCode) = '301' )"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="not ( normalize-space(cbc:DocumentTypeCode) = '301' )">
               <xsl:attribute name="flag">error</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-get-full-path"/>
               </xsl:attribute>
               <svrl:text>error.parent_document_documenttypecode_check_application_response</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M11"/>
   ...
   <!--PATTERN SubmitApplicationResponse_code_list_rules-->
