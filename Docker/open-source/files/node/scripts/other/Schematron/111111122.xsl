...
<xsl:template match="/">
      <svrl:schematron-output xmlns:xs="http://www.w3.org/2001/XMLSchema"
                              xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Business rules for e-PRIOR ReceiptAdvice"
                              schemaVersion="">
         ...
         <svrl:active-pattern>
            <xsl:attribute name="id">ReceiptAdvice_code_list_rules</xsl:attribute>
            <xsl:attribute name="name">ReceiptAdvice_code_list_rules</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
...
<svrl:text xmlns:xs="http://www.w3.org/2001/XMLSchema"
              xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Business rules for e-PRIOR ReceiptAdvice</svrl:text>

   <!--PATTERN -->


	<!--RULE -->
<xsl:template match="*[local-name()='ReceiptAdvice']/cbc:ID" priority="1000" mode="M7">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='ReceiptAdvice']/cbc:ID"/>
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="*[local-name()='ReceiptAdvice']" priority="1000" mode="M8">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='ReceiptAdvice']"/>
...
<xsl:choose>
   ...
   <!--PATTERN -->
	...
	<!--RULE -->
<xsl:template match="*[local-name()='ReceiptAdvice']" priority="1000" mode="M9">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="*[local-name()='ReceiptAdvice']"/>
...
<xsl:choose>
   ...
   <!--PATTERN ReceiptAdvice_code_list_rules-->


	<!--RULE -->
<xsl:template match="cbc:DocumentStatusCode" priority="1001" mode="M10">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="cbc:DocumentStatusCode"/>
...
<xsl:choose>
	  ...
	  <!--RULE -->
<xsl:template match="cbc:TaxTypeCode" priority="1000" mode="M10">
      <svrl:fired-rule xmlns:xs="http://www.w3.org/2001/XMLSchema"
                       xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
