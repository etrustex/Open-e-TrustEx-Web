										...
										<tbody>
											<tr>
												...
												<td style="border:1; border-color:black; " align="center" width="80%">
													<h2>
														<xsl:for-each select="n1:AdhocC2S">
										...
										<tbody>
											...
											<tr>
												...
												<xsl:choose>
													...
													<xsl:otherwise>
														<td style="border:1; border-color:black; " width="35%">.</td>
													</xsl:otherwise>
												</xsl:choose>
